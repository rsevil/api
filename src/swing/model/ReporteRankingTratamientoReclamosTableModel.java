...
public class ReporteRankingTratamientoReclamosTableModel extends AbstractTableModel {
	...
	public ReporteRankingTratamientoReclamosTableModel() {
	 ...
	 * @param columnNames
	 */
	public ReporteRankingTratamientoReclamosTableModel(ArrayList<String> columnNames) {
		this();
	 ...
	 * @param itemsReporte
	 */
	public ReporteRankingTratamientoReclamosTableModel(ArrayList<String> columnNames, ArrayList<ReporteView> itemsReporte) {
		super();
		this.columnNames = columnNames;
