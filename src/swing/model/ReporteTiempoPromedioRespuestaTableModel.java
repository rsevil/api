...
public class ReporteTiempoPromedioRespuestaTableModel extends AbstractTableModel {
	...
	public ReporteTiempoPromedioRespuestaTableModel() {
	 ...
	 * @param columnNames
	 */
	public ReporteTiempoPromedioRespuestaTableModel(ArrayList<String> columnNames) {
		this();
	 ...
	 * @param itemsReporte
	 */
	public ReporteTiempoPromedioRespuestaTableModel(ArrayList<String> columnNames, ArrayList<ReporteView> itemsReporte) {
		super();
		this.columnNames = columnNames;
