...
public class ReporteReclamosTratadosMesAnioTableModel extends AbstractTableModel {
	...
	public ReporteReclamosTratadosMesAnioTableModel() {
	 ...
	 * @param columnNames
	 */
	public ReporteReclamosTratadosMesAnioTableModel(ArrayList<String> columnNames) {
		this();
	 ...
	 * @param itemsReporte
	 */
	public ReporteReclamosTratadosMesAnioTableModel(ArrayList<String> columnNames, ArrayList<ReporteView> itemsReporte) {
		super();
		this.columnNames = columnNames;
