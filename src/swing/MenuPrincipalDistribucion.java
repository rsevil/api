...
import swing.model.TratamientoDistribucionTableModel;
...
public class MenuPrincipalDistribucion extends javax.swing.JFrame {
	...
	private TratamientoDistribucionTableModel tableModel;
	...
	private ArrayList<JMenuItem> getItemsMenu(ReclamoDistribucionView reclamo) {
	...
	private void mostrarPopUpNovedad(EstadosReclamo estado) {
		int selectedRow = tablaReclamos.getSelectedRow();
		if (selectedRow > -1) {
			ReclamoDistribucionView itemRow = tableModel.getItemRow(selectedRow);
	...
	private void actualizarDatos() {
		...
		columnNames.add("Cantidad de Productos");
		columnNames.add("Producto");
		columnNames.add("Cantidad de Productos Faltantes");
		columnNames.add("Producto");
		ArrayList<ReclamoDistribucionView> reclamos = new ArrayList<ReclamoDistribucionView>(
				SistemaAdministracionReclamos.getInstancia().obtenerReclamosDistribucionTratamiento());
		tableModel = new TratamientoDistribucionTableModel(columnNames, reclamos);
